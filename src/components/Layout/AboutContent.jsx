...
const AboutContent = () => {
    return (
        <div className="max-w-screen-xl mx-auto lg:pt-40 lg:px-6 md:py-12 md:px-6 md:pt-60 py-9 px-6 pt-40 h-screen">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div className="w-full lg:w-8/12 ">
                    <img className="w-full h-full" src={graffitiImage} alt="girl lookin at street art" />
                </div>
            </div>
        </div>
    );
